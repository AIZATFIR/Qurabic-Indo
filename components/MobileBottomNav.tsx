...
import { Home, BookOpen, Heart, Search, BookMarked } from 'lucide-react';
...
export default function MobileBottomNav() {
  ...
  const navItems = [
    ...
    { label: 'Baca Qur\'an', href: '/baca', icon: BookMarked },
  ...
  return (
    <>
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-lg border-t border-hairline px-3 py-2 shadow-2xl">
        <div className="flex items-center justify-around max-w-md mx-auto">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center space-y-0.5 py-1 px-2.5 rounded-2xl text-slate-500 hover:text-primary transition-all"
          >
