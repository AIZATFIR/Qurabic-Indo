  ...
  return (
    <div className="space-y-14 pb-16">
      ...
      <header className="relative pt-16 pb-16 bg-white dark:bg-[#0B1410] border-b border-hairline dark:border-hairline-dark">
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10 space-y-5">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-light text-ink-primary dark:text-white tracking-tight font-sans leading-tight">
            ...
            <span className="font-semibold text-primary dark:text-primary-light">Bahasa Al-Qur&apos;an</span>
          </h1>

          <p className="text-sm sm:text-base text-ink-secondary dark:text-stone-300 font-light max-w-lg mx-auto leading-relaxed font-sans">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 text-xs text-ink-mute dark:text-stone-400 pt-1">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          >
            ...
            <p className="text-xs text-ink-mute dark:text-stone-400 leading-relaxed font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-12 space-y-10">
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-3 border-b border-hairline dark:border-hairline-dark pb-3">
          <div>
            <h2 className="text-xl sm:text-2xl font-light text-ink-primary dark:text-white tracking-tight font-sans">
              Akar Kata Populer Al-Qur&apos;an
            </h2>
            <p className="text-xs text-ink-mute dark:text-stone-400 mt-0.5 font-sans">
              Etimologi dan turunan kata kerja (Fi&apos;il) serta kata benda (Isim) dalam Bahasa Indonesia.
            </p>
          </div>
          <Link
            href="/morfologi"
            className="text-xs font-semibold text-primary dark:text-primary-light hover:underline flex items-center space-x-1 transition-colors"
          >
